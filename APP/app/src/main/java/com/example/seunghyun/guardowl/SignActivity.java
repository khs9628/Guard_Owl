...
public class SignActivity extends AppCompatActivity {
    ...
    public EditText Name, NewId, NewPhone, NewEmail, NewPw1, NewPw2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NewId.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.length() > 20){
                    isId = false;
                    Toast.makeText(getApplicationContext(), "아이디는 20자 이내로 작성해주세요",
        ...
        btnCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    String result = new Task(sendmsg).execute(id, "signUp_list").get();
                    String oj = new String(result);
                    if(oj.trim().length()>0) {
        ...
        btnSign.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (Name.getText().toString().equals("") || NewId.getText().toString().equals("") || NewEmail.getText().toString().equals("") || NewPw1.getText().toString().equals("")|| NewPhone.getText().toString().equals("")) {
                ...
                Toast.makeText(getApplicationContext(), "휴대폰 번호는 11자리로 입력해주세요",
                        Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    try {
                        String rst = new Task(sendmsg).execute(name, id, email, pw,phone, "signUp_write", "id_write", "email_write", "pw_write", "phone_write").get();
